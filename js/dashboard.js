...
const caseData = {
  // Respondent State Cases (existing data)
  'Indo Gold v. India': {
  ...
  // Home State of Claimant Cases (from Google Sheets)
  'Mittal v. Bosnia and Herzegovina': {
    'case-name': 'Mittal v. Bosnia and Herzegovina',
    'full-case-name': 'Mittal Steel Company N.V. v. Bosnia and Herzegovina',
    'case-number': 'ICSID Case No. ARB/17/47',
    'nature-of-proceedings': 'International',
    'type-of-case': 'Investor-State',
    'rules-of-arbitration': 'ICSID Convention - Arbitration Rules',
    ...
    'applicable-treaties': 'India - Bosnia and Herzegovina BIT',
    'administering-institution': 'ICSID',
    'state-gov-involved': 'N/A',
    'parties-claimant': 'Mittal Steel Company N.V.<br>Represented by: International law firm',
    'parties-respondent': 'Bosnia and Herzegovina<br>Represented by: Government legal team',
    'tribunal-composition': 'President: TBD<br>Arbitrator (Claimant): TBD<br>Arbitrator (Respondent): TBD',
    'breaches-alleged-found': 'IIA breaches alleged<br>Fair and equitable treatment<br>Expropriation<br>IIA breaches found<br>Pending',
    'summary': 'Investment in Global Ispat Koksna Industrija d.o.o. Lukavac ("GIKIL"), a producer of metallurgical coke. Claims arising out of local authorities\' actions affecting the investment in metallurgical coke production.',
    'amount-of-compensation': 'Claimed by investor<br>Data not available<br>Awarded by tribunal<br>Data not available',
    'latest-documents': 'Request for Arbitration - 2023',
    'other-documents': 'Notice of Intent - 2023',
  ...
  'Binani v. North Macedonia (II)': {
    ...
    'case-number': 'ICSID Case No. ARB/20/XX',
    'nature-of-proceedings': 'International',
    'type-of-case': 'Investor-State',
    'rules-of-arbitration': 'ICSID Convention - Arbitration Rules',
    ...
    'status-of-case': 'Pending',
    'claimant-country': 'India',
    'applicable-treaties': 'India - North Macedonia BIT',
    'administering-institution': 'ICSID',
    'state-gov-involved': 'N/A',
    'parties-claimant': 'Binani Industries Limited<br>Represented by: International law firm',
    'parties-respondent': 'Republic of North Macedonia<br>Represented by: Government legal team',
    'tribunal-composition': 'President: TBD<br>Arbitrator (Claimant): TBD<br>Arbitrator (Respondent): TBD',
    'breaches-alleged-found': 'IIA breaches alleged<br>Expropriation<br>Fair and equitable treatment<br>IIA breaches found<br>Pending',
    'summary': 'Concessions to mine lead and zinc held by a local subsidiary, Indo Minerals & Metals, part of the Binani Group of Industries. Claims arising out of the Government\'s alleged expropriation of the claimants\' mining concessions and their reassignment to another company by auction.',
    'amount-of-compensation': 'Claimed by investor<br>Data not available<br>Awarded by tribunal<br>Data not available',
    'latest-documents': 'Request for Arbitration - 2020',
    'other-documents': 'Notice of Intent - 2020',
    'background-scores': 'Data not available'
  },
  'Patel v. Mozambique': {
    'case-name': 'Patel v. Mozambique',
    'full-case-name': 'Patel Infrastructure Limited v. Republic of Mozambique',
    'case-number': 'ICSID Case No. ARB/20/XX',
    'nature-of-proceedings': 'International',
    'type-of-case': 'Investor-State',
    'rules-of-arbitration': 'ICSID Convention - Arbitration Rules',
    ...
    'claimant-country': 'India',
    'applicable-treaties': 'India - Mozambique BIT',
    'administering-institution': 'ICSID',
    'state-gov-involved': 'N/A',
    'parties-claimant': 'Patel Infrastructure Limited<br>Represented by: International law firm',
    'parties-respondent': 'Republic of Mozambique<br>Represented by: Government legal team',
    'tribunal-composition': 'President: TBD<br>Arbitrator (Claimant): TBD<br>Arbitrator (Respondent): TBD',
    'breaches-alleged-found': 'IIA breaches alleged<br>Fair and equitable treatment<br>IIA breaches found<br>None - all claims dismissed',
    'summary': 'Investments in a project to construct a railway line and develop a new port at the Zambezia coast through a planned public-private partnership. Claims arising out of the decision of the Transport and Communications Ministry to conduct a public tender for a concession allegedly promised to the claimant under a 2011 memorandum of interest between the ministry and the claimant; the concession was subsequently awarded to a third party.',
    'amount-of-compensation': 'Claimed by investor<br>Data not available<br>Awarded by tribunal<br>Data not available',
    'latest-documents': 'Final Award - 2023',
    'other-documents': 'Request for Arbitration - 2020',
    'background-scores': 'Data not available'
  },
  'Khadamat v. Saudi Arabia': {
    'case-name': 'Khadamat v. Saudi Arabia',
    'full-case-name': 'Khadamat Infrastructure Services Limited v. Kingdom of Saudi Arabia',
    'case-number': 'ICSID Case No. ARB/18/XX',
    'nature-of-proceedings': 'International',
    'type-of-case': 'Investor-State',
    'rules-of-arbitration': 'ICSID Convention - Arbitration Rules',
    ...
    'status-of-case': 'Decided in favour of State',
    'claimant-country': 'India',
    'applicable-treaties': 'India - Saudi Arabia BIT',
    'administering-institution': 'ICSID',
    'state-gov-involved': 'N/A',
    'parties-claimant': 'Khadamat Infrastructure Services Limited<br>Represented by: International law firm',
    'parties-respondent': 'Kingdom of Saudi Arabia<br>Represented by: Government legal team',
    'tribunal-composition': 'President: TBD<br>Arbitrator (Claimant): TBD<br>Arbitrator (Respondent): TBD',
    'breaches-alleged-found': 'IIA breaches alleged<br>Fair and equitable treatment<br>IIA breaches found<br>None - all claims dismissed',
    'summary': 'Investment in infrastructure and development projects in Saudi Arabia. Claims arising out of alleged breaches of investment agreements and regulatory measures affecting the claimant\'s investments.',
    'amount-of-compensation': 'Claimed by investor<br>Data not available<br>Awarded by tribunal<br>Data not available',
    'latest-documents': 'Final Award - 2022',
    'other-documents': 'Request for Arbitration - 2018',
    'background-scores': 'Data not available'
  }
};
